...
export const gridItems = [
  ...
  {
    id: 5,
    title: "Currently building a Next.js Finance Platform",
...
export const projects = [
  ...
  {
    id: 2,
    title: "Foodies - An Online Food Ordering App",
  ...
  {
    id: 3,
    title: "PicDetective - An AI Image Analyser",
    des: "An AI Image Analyser that can detect and classify objects in your images.",
    img: "./a.svg",
    iconLists: ["./re.svg", "./tail.svg", "./ts.svg", "./ge.png", "./c.svg"],
    link: "https://picdetective.vercel.app",
  },
  {
    id: 4,
    title: "Multi-Store Administrator App",
    des: "A multi store administrator web app that can be linked with any frontend web app via API integration",
    img: "./ad.svg",
    iconLists: ["./next.svg", "./tail.svg", "./ts.svg", "./fire.svg"],
    link: "https://administrator-portal.vercel.app",
  },
];
...
export const workExperience = [
  ...
  {
    id: 3,
    title: "Google Arcade Participant",
    desc: "Participated in Google Arcade Program 2024 and won prizes",
    className: "md:col-span-2", // change to md:col-span-2
    thumbnail: "./exp3.svg",
  },
  {
